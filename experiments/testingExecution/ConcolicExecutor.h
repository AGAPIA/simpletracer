...
class ConcolicExecutor {
    ...
    public:
        ...
        TestGraph* GenerateExecutionTree(string start_input);
    private:
        ...
        std::vector<TestCase> CallSimpleTracer(pid_t child_pid, const char *testInput);
        ...
        std::vector <string> GenerateTestCases(const char *rootInput, std::vector<TestCase> initialTestCases);
